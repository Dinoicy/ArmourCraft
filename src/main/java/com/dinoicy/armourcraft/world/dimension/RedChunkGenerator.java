...
public class RedChunkGenerator extends NoiseChunkGenerator<RedGenSettings> {
    ...
    public RedChunkGenerator(IWorld worldIn, BiomeProvider provider, RedGenSettings settingsIn) {
