package com.dinoicy.armourcraft.entities;
...
public class RedAnimalEntity extends AnimalEntity {

    private EatGrassGoal eatGrassGoal;
    private int exampleTimer;

    public RedAnimalEntity(EntityType<? extends AnimalEntity> type, World worldIn) {
        super(type, worldIn);
    }

    @Override
    public AgeableEntity createChild(AgeableEntity ageable) {
        RedAnimalEntity entity = new RedAnimalEntity(ArmourEntityTypes.RED_ANIMAL_ENTITY.get(), this.world);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3,
                new TemptGoal(this, 1.1D, Ingredient.fromItems(ItemInit.red_item.get()), false));
